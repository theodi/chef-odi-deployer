...
describe file("/var/www/staging.certificates.theodi.org/current/config.ru") do
 it { should be_file }
end

describe file("/var/www/staging.certificates.theodi.org/current/public/assets/") do
...
describe command("curl -H 'Host: staging.certificates.theodi.org' localhost") do
  it { should return_stdout /ODI Open Data Certificate/ }
end

describe file('/var/www/staging.certificates.theodi.org/shared/log/production.log') do
